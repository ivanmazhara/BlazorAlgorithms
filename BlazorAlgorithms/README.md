# Blazor Algorithms Explorer

A web-based application built with Blazor and .NET 8 to visualize, test, and compare various array operations and sorting algorithms.
...
3. Press `F5` or click **Start Debugging** to launch the application in your browser.
